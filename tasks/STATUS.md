...
| ------ | ------------------------------------------------------------------ | ------------- | ---------- | ---------- |
| F1-S01 | Schema documents para upload async (status + error + processed_at) | 🔵 in-progress | high       | —          |
| F1-S02 | Expor ingestBuffer e reaproveitar pipeline na CLI                  | ⏸️ blocked    | high       | —          |
| F1-S03 | API /api/documents (POST upload + GET listagem por tenant)         | ⏸️ blocked    | high       | —          |
